$(document).ready(function(){
    ...
    $(window).resize(function(){
        if (window.innerWidth < 768) {
            gsap.fromTo("#section8 .tab-nav", {top: -110, opacity: 0}, {duration: 1.4, top: 90, opacity: 1, delay:1.5, ease: Power3.easeOut});
        } else {
            gsap.fromTo("#section8 .tab-nav", {y: 100, opacity: 0}, {delay: 0.4, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
        }
    }).resize();
    ...
    // section8
    gsap.fromTo("#tab01 .swiper", {y: 100, opacity: 0}, {delay: 0.6, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
    gsap.fromTo("#tab01 .txt-wrap", {y: 100, opacity: 0}, {delay: 0.8, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
    ...
    $('.tab-nav li:nth-child(3)').click(function(){
        gsap.fromTo("#tab02 .swiper", {y: 100, opacity: 0}, {delay: 0.4, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
        gsap.fromTo("#tab02 .txt-wrap", {y: 100, opacity: 0}, {delay: 0.6, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
        gsap.fromTo("#tab02 .table-wrap", {y: 100, opacity: 0}, {delay: 0.8, duration: 1.5, y: 0, opacity: 1, ease: Power3.easeOut});
    })

    $('.tab-nav li:nth-child(4)').click(function(){
        gsap.fromTo("#tab03 .img-box .box", {y: 100, opacity: 0}, {delay: 0.4, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
        gsap.fromTo("#tab03 .img-box .img01", {y: 100, opacity: 0}, {delay: 0.6, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
        gsap.fromTo("#tab03 .img-box .img02", {y: 100, opacity: 0}, {delay: 0.8, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
        gsap.fromTo("#tab03 .title", {y: 100, opacity: 0}, {delay: 1, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
        gsap.fromTo("#tab03 p", {y: 100, opacity: 0}, {delay: 1.2, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
        gsap.fromTo("#tab03 .btn-center", {y: 100, opacity: 0}, {delay: 1.4, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
    })
    ...
    $('#main #fullpage').fullpage({
        ...
        onLeave: function(index, nextIndex, direction){
            ...
            if(nextIndex == 2){
                gsap.fromTo("#section2 .title", {y: 100, opacity: 0}, {delay: 0.4, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
                gsap.fromTo("#section2 p", {y: 100, opacity: 0}, {delay: 0.6, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
                gsap.fromTo("#section2 .more-btn", {y: 100, opacity: 0}, {delay: 0.8, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
                gsap.fromTo("#section2 .img-area", {y: 100, opacity: 0}, {delay: 1, duration: 1.5, y: 0, opacity: 1, ease: Power3.easeOut});
                gsap.fromTo("#section2 .arrow.mo", {y: 100, opacity: 0}, {delay: 1.2, duration: 1.5, y: 0, opacity: 1, ease: Power3.easeOut});
            }

            if(nextIndex == 3){
                gsap.fromTo("#section3 .title", {y: 100, opacity: 0}, {delay: 0.4, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
                gsap.fromTo("#section3 p", {y: 100, opacity: 0}, {delay: 0.6, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
                gsap.fromTo("#section3 .more-btn", {y: 100, opacity: 0}, {delay: 0.8, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
                gsap.fromTo("#section3 .img-area", {y: 100, opacity: 0}, {delay: 1, duration: 1.5, y: 0, opacity: 1, ease: Power3.easeOut});
                gsap.fromTo("#section3 .arrow.mo", {y: 100, opacity: 0}, {delay: 1.2, duration: 1.5, y: 0, opacity: 1, ease: Power3.easeOut});
            }

            if(nextIndex == 4){
                gsap.fromTo("#section4 .title", {y: 100, opacity: 0}, {delay: 0.4, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
                gsap.fromTo("#section4 p", {y: 100, opacity: 0}, {delay: 0.6, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
                gsap.fromTo("#section4 .more-btn", {y: 100, opacity: 0}, {delay: 0.8, duration: 1.2, y: 0, opacity: 1, ease: Power3.easeOut});
                gsap.fromTo("#section4 .img-area", {y: 100, opacity: 0}, {delay: 1, duration: 1.5, y: 0, opacity: 1, ease: Power3.easeOut});
            }
        }
    });
